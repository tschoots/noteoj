...
public class DatabaseConfigurationFactory implements IPropertyConfigurationFactory {
    ...
    public Optional<PropertyConfiguration> create(String configurationName) {
        ...
        logger.info("Attempting to create dynamic database property configuration.");
